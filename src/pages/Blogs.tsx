        ...
        <section className="container">
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 space-y-4">
              <h2 className="font-serif text-xl font-bold text-foreground mb-4">All Articles</h2>
              {articles.map((article) => (
                <button
                  key={article.id}
                  onClick={() => setSelectedArticle(article)}
                  className={`w-full text-left p-4 rounded-xl border transition-all duration-300 animate-fade-in ${
            ...
            <div className="lg:col-span-7">
              <article className="bg-card rounded-2xl overflow-hidden shadow-card border border-border/50 sticky top-32">
                ...
                <div className="p-6 md:p-8">
                  ...
                  <div className="prose prose-sm max-w-none text-muted-foreground max-h-[400px] overflow-y-auto pr-2">
